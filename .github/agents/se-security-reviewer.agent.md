...
handoffs: 
  - label: Begin drafting plan to Fix Security Issues
    agent: agent
    prompt: Draft a plan to fix the identified security issues, prioritizing based on severity and impact. Include specific code changes needed, categorized by priority level (e.g., Critical, High, Medium, Low).
    send: true
---
...
**Code Review Report** - Save to `docs/[date]-[component]-review.md`
